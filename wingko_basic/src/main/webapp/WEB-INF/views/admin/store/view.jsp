...
<div id="Wrapper">
    ...
    <div id="Content"><!--Content-->
		...
		<div class="con">
			<form method="post" <c:if test="${store.store_no > 0 }">action="/admin/store/update.do"</c:if>>
			<table class="info">
				<colgroup>
					<col width="20%" />
					<col width="16%" />
				...
				<tr>
					<th>상호명</th>
					<td colspan="5"><form:input path="store.title" cssClass="txt01" cssStyle="width:90%;"/> (31/100)</td>
				</tr>
				<tr>
					<th>카테고리 분류</th>
					<td colspan="5">
				...
				<tr>
					...
					<td class="pic">
						<div style="width: 100%; height: 100%; position: relative;">
							<a href="#"><span class="span_file" ><input type="file" name="file_image_thumb" class="input_file" /><form:input path="store.image_thumb" type="text" /></span></a>
						</div>
					</td>
					<td class="pic">
						<div style="width: 100%; height: 100%; position: relative;">
							<a href="#"><span class="span_file" ><input type="file" name="file_image" class="input_file" /><form:input path="store.image" type="text" /></span></a>
						</div>
					</td>
					<td class="pic">
						<div style="width: 100%; height: 100%; position: relative;">
							<a href="#"><span class="span_file" ><input type="file" name="file_image1" class="input_file" /><form:input path="store.image1" type="text" /></span></a>
						</div>
					</td>
					<td class="pic">
						<div style="width: 100%; height: 100%; position: relative;">
							<a href="#"><span class="span_file" ><input type="file" name="file_image2" class="input_file" /><form:input path="store.image2" type="text" /></span></a>
						</div>
					</td>
					<td class="pic">
						<div style="width: 100%; height: 100%; position: relative;">
							<a href="#"><span class="span_file" ><input type="file" name="file_image3" class="input_file" /><form:input path="store.image3" type="text" /></span></a>
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<th>주소입력</th>
					<td colspan="5"><div class="black">우편번호</div> <form:input path="store.address" cssClass="txt01" cssStyle="width:200px;" /></td>
				</tr>
				<tr>
					<th>전화번호</th>
				...
				<tr>
					<th>휴일</th>
					<td colspan="5"><form:input path="store.holiday" cssClass="txt01" cssStyle="width:200px;"/></td>
				</tr>
				<tr>
					<th>가능외국어서비스</th>
					<td colspan="5">
						...
						<span><label for="language_service4"> 기타외국어입력 &nbsp;&nbsp;</label><input id="language_service4" name="language_service" type="text" value="${store.language_service }"/></span>
					</td>
				</tr>
				<tr>
					<th>지불방법</th>
					<td colspan="5">
						...
						<span><label for="payment3"> 기타 &nbsp;&nbsp;</label><input id="payment3" name="payment" type="text" value="${store.payment }"/></span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="5">기타 &nbsp;&nbsp; <form:input path="store.traffic" cssClass="txt01" cssStyle="width:600px;"/></td>
				</tr>
				<tr>
					<th>추가정보</th>
				...
				<tr>
					<th>상세설명</th>
					<td colspan="5" class="edit"><form:textarea path="store.content" cols="100" rows="20"/></td>
				</tr>
			</table>
			</form>
...
$(function () {
    $('input:file').fileupload({
        dataType: 'json',
        url: '/admin/store/imageupload.do',

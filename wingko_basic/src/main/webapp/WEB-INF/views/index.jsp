...
<meta name="google-site-verification" content="hX1lvrgZFt_0mMNdIwskw14JSQLOwk1C30aCnBMDUAc" />
...
<script>
		...
		$.each(adNewsData, function(key, val) {
			...
			if (val.length > 0) {
				for ( var j = 0; j < val.length; j++) {
					...
					if (adNews.title.length >= 12) {
						adNews.title = adNews.title.substring(0, 12)+"..";
					}
			...
			complete: function(data){
				...
				$.each(obj.adList, function(key, val) {
					...
					if (val.position == "5") {
						...
						adhtml = "<a href=\""+val.link+"\" target=\"_blank\"><img style='margin-bottom:0px;' src=\"http://www.wingkostory.com/upload/ad/"+val.image+"\" alt=\"광고\" /></a>";						
					} // 라인발생으로 인라인스타일변경
			...
			complete: function(data){
				...
				$.each(obj, function(key, val) {
					...
					if (i == 1) {
						...
						html += "<li class='two'><a href='/store/main.do?store_no="+val.store_no+"'>"+val.coupon_name+"</a></li>";	
					} else if (i == 3) {
						html += "<li class='three'><a href='/store/main.do?store_no="+val.store_no+"'>"+val.coupon_name+"</a></li>";	
					} else { }
				});
	...
	*/
	var adNewsData = {
			on: ["/resources/img/main/add_tab04_on.png", "/resources/img/main/add_tab05_on.png", "/resources/img/main/add_tab03_on.png",
			     "/resources/img/main/add_tab01_on.png", "/resources/img/main/add_tab02_on.png", "/resources/img/main/add_tab06_on.png"],
			off: ["/resources/img/main/add_tab04.png", "/resources/img/main/add_tab05.png", "/resources/img/main/add_tab03.png",
				 "/resources/img/main/add_tab01.png", "/resources/img/main/add_tab02.png", "/resources/img/main/add_tab06.png"],
...
<%-- 	<div id="myCarousel" class="main_picture carousel slide">
    ...
    <div id="Left"><!--여기부터 왼쪽메뉴 시작-->
        <div class="traffic"><!--교통-->
        	<a href="/travel/info.do?menu=traffic&no=8"><img src="/resources/img/main/t_airplane.png" alt="airplane" class="mt_5"/></a>
...
${ex_now}￦</td>
        ...
        <div class="map02" id="ad1"></div> <!--양옆회색라인발생방지 클래스새로정의-->
        <div class="map02" id="ad2"></div>
    ...
    <div id="Center"><!--여기부터 Center 시작-->
       ...
       <div class="toon2" id="ad9"></div><!--축제지도안내배너--><!--ad9-->
       <div><ul class="add_tab"> <!--뉴스탭-->
           	<li><a href="javascript:adNewsTab(0);"><img src="/resources/img/main/add_tab04<c:if test="${rnd == 0 }">_on</c:if>.png" alt="新消息" id="adNewsImg1" /></a></li>
            <li><a href="javascript:adNewsTab(1);"><img src="/resources/img/main/add_tab05<c:if test="${rnd == 1 }">_on</c:if>.png" alt="推荐信息" id="adNewsImg2" /></a></li>
        ...
        <div style="padding:2px; background-color:#e7eff7; border:solid 1px #b4cce4" >
        <div class="m_title" style="border-top: 1px solid #e7eff7;border-left: 1px solid #e7eff7;border-right: 1px solid #e7eff7; text-align:center; padding:0; border-bottom:hidden "><!--예약-->
        ...
        <ul class="add_tab"> <!--뉴스탭-->
			<li><a href="javascript:adNewsTab(3);"><img src="/resources/img/main/add_tab01<c:if test="${rnd == 0 }">_on</c:if>.png" alt="新消息" id="adNewsImg4" /></a></li>
            <li><a href="javascript:adNewsTab(4);"><img src="/resources/img/main/add_tab02<c:if test="${rnd == 1 }">_on</c:if>.png" alt="推荐信息" id="adNewsImg5" /></a></li>
...
<script type="text/javascript">
	var AgodaSearch = new AgodaSearchBox({
		...
		currencyCode: 'CNY',
		newWindow: true,
		header: 'http://wingkostory.com/top.html',
		/* 
			http://wingkostory.com/top.html 
			http://www.wingkostory.com/resources/img/logo.png
		*/
...
<style>
	.hotel{border:1px solid #e7eff7; border-top:hidden; background:#fff; height:165px;}
	#AgodaSearchBox {
		width:540px;
		text-align:left;
		margin-top:16px;

...
<div id="Wrapper">
	...
	<div id="Content">
    	<ul class="location">
        	...
        	<a href="main.do"><li>회사소개</li></a>
        	<li class="end">
        		<c:if test="${info.no == '7' }">광고개요</c:if>
        		<c:if test="${info.no == '8' }">윙코스토리 광고</c:if>
        		<c:if test="${info.no == '9' }">커뮤니티 광고</c:if>
        		<c:if test="${info.no == '10' }">광고혜택/매체자료</c:if>
        	</li>
        </ul>

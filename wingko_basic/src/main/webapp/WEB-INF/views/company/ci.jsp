...
<div id="Wrapper">
	...
	<div id="Content">
    	<ul class="location">
        	<li class="first"><img src="/resources/img/home.png" alt="home" /></li><a href="main.do"><li>회사소개</li></a><li class="end">CI &amp; BI</li>
        </ul>
        <div class="com_menu"><!--회사소개메뉴-->
        	...
        	<a href="ci.do"><img src="/resources/img/menu/company_m04_on.png" alt="CI &amp; BI" /></a><br/>

...
<div id="Wrapper">
	...
	<div id="Content">
    	<ul class="location">
        	<li class="first"><img src="/resources/img/home.png" alt="home" /></li><a href="main.do"><li>회사소개</li></a><li class="end">문의안내</li>
        </ul>
        ...
        <div class="sub_tit"><img src="/resources/img/title/tit_question_guide.png" alt="문의안내" /></div><!--title-->
        <div class="company_con">
        	${info.content}
        </div>
        <div class="bt_center" style="margin-top:30px;"><a href="question_write.do"><img src="/resources/img/button/btn_question.png" alt="문의(询问)" /></a></div>
   </div>

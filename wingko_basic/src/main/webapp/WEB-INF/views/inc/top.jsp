...
/* 		function viewBanner(){
			...
			complete: function(data){
				...
				$.each(obj, function(key, val) {
					...
					if ( _content_type == "store" ) {
						_html += "<tr><td height='55px' valign='top' class='hand' onclick=\"javascript:goStore('"+_no+"');\"><img src=\"http://www.wingkostory.com/upload/store/"+_img+"\" style='width: 80px; height: 55px;' /></td></tr>";
						_html += "<tr><td valign='top' class='hand' onclick=\"javascript:goStore('"+_no+"');\">"+_title+"</td></tr>";
						
					} else {
						_html += "<tr><td height='55px' valign='top' class='hand' onclick=\"javascript:goNews('"+_no+"');\"><img src=\"http://www.wingkostory.com/upload/news/"+_img+"\" style='width: 80px; height: 55px;' /></td></tr>";
						_html += "<tr><td valign='top' class='hand' onclick=\"javascript:goNews('"+_no+"');\">"+_title+"</td></tr>";
					}
	...
	<div id="Top">
		...
		<div class="logo"><a href="/index.do"><img src="/resources/img/logo.png" alt="WINGKOSTORY" /></a></div><!--로고-->
		<form method="post" action="/search/result.do" id="s_form">
        <div class="search"><!--검색창-->
        	<input type="text" class="s_txt" name="searchString" id="searchString" /><a href="#"><img src="/resources/img/main/suggest.png" alt="서제스트" style="vertical-align:top " /></a><a href="#" id="top_search"><img src="/resources/img/main/m_search.png" alt="검색" style="vertical-align:top"/></a>
        </div>
        </form>
			...
			<li id="btn_sub_3">
				...
				<div class="a3" id="a3" style="display: none;">
					<table class="menu_d">
						...
						<tr onclick="javascript:go('/deal/main.do');"><td>本月推荐商品</td></tr>
					</table>
				</div>
			</li>
			<li id="btn_sub_4">
		...
		<p class="wingend"><a href="/wingshow/info.do"><img src="/resources/img/main/m_menu10.png" alt="wingshow?" /></a></p>        
	</div>
	<div class="main_picture">
		...
		<div class="quick" id="quick_menu">
            ...
            <table height="480"> <!--상단맞춤용 테이블-->
                ...
                <table>
                	<tr>
                	<td><a href="#top"><img style="border:none" src="/resources/img/quick_top.png" /></a></td>
                    </tr>
                </table>
			</div>
		</div>

...
/* 		function viewBanner(){
		...
		$.ajax({
			...
			complete: function(data){
				...
				$.each(obj, function(key, val) {
					...
					if (i == 1) {
						_html = "<div class=\"active item\"><a href=\""+_link+"\"><img src=\"http://www.wingkostory.com/upload/ad/"+_image+"\" alt=\"배너\" style='width:190px; height:118px;' /></a></div>";
					} else {
						_html = "<div class=\"item\"><a href=\""+_link+"\"><img src=\"http://www.wingkostory.com/upload/ad/"+_image+"\" alt=\"배너\" style='width:190px; height:118px;' /></a></div>";
					}

					$("#carousel-inner").append(_html);
	...
	<div id="Top">
		...
		<div id="myCarouselTopRight" class="top_banner carousel slid">
			<!-- <div class="b_pic_prev"></div>이전배너 절대값버튼
			<div class="b_pic_next"></div>다음배너 절대값버튼
			<img src="/resources/img/main/main_banner.png" alt="배너" /> -->
			<!-- Carousel items -->
	    	<div class="left b_pic_prev" href="#myCarouselTopRight" data-slide="prev"></div>
			<div class="right b_pic_next" href="#myCarouselTopRight" data-slide="next"></div>

...
<div id="Wrapper">
	...
	<div id="Content">
        ...
        <table class="board_write" print_view>
            ...
            <tr>
            	<th>经营范围</th><!--주요사업,내용-->
                <td colspan="3"><div class="txtarea2" style="overflow: auto;">${job.company_desc}</div></td>
            </tr>
             <tr>
            	<th>地址</th><!--주소-->
                <td colspan="3">${job.company_address}</td>
            </tr>
            <tr>
            	<th>电话</th><!--전화-->
                <td>${job.company_tel}</td>
            	<th>联系人/邮箱</th><!--담당자,이메일-->
                <td>${job.company_contact} / ${job.company_email}</td>
            </tr>
             <tr>
            	<th>工作地点</th><!--근무지역-->
                <td>${job.company_location}</td>
            	<th>招工职位</th><!--직종-->
                <td>${job.company_jobs}</td>
            </tr>
            <tr>
            	<th>雇佣形式</th><!--고용형태-->
                <td>${job.company_employ}</td>
            	<th>招聘人数</th><!--모집인원-->
                <td>${job.company_recruite}</td>
            </tr>
            <tr>
            	<th>收入</th><!--임금조건-->
                <td>${job.company_pay}</td>
            	<th>工作经历</th><!--경력조건-->
                <td>${job.company_career}</td>
            </tr>
            <tr>
            	<th>其他招聘条件</th><!--기타 구인조건-->
                <td colspan="3"><div class="txtarea2" style="overflow: auto;">${job.company_etc}</div></td>
            </tr>
            <tr>
            	<th>密码</th><!--비밀번호-->

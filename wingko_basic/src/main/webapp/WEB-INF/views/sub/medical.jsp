...
var store = {
	...
	tab : {
		on: ["/resources/img/menu/medical_tab01_on.png", "/resources/img/menu/medical_tab02_on.png", "/resources/img/menu/medical_tab03_on.png",
		     "/resources/img/menu/medical_tab04_on.png", "/resources/img/menu/medical_tab05_on.png", "/resources/img/menu/medical_tab06_on.png"],
		off: ["/resources/img/menu/medical_tab01.png", "/resources/img/menu/medical_tab02.png", "/resources/img/menu/medical_tab03.png",
		     "/resources/img/menu/medical_tab04.png", "/resources/img/menu/medical_tab05.png", "/resources/img/menu/medical_tab06.png"],
		category: [30, 31, 32, 48, 49, 50],	// category_no
		id: ["li_30", "li_31", "li_32", "li_48", "li_49", "li_50"]	// tab li id
	},
...
<div id="Wrapper">
	...
	<div id="Content">
        ...
        <ul class="tab_detail_c3" style="margin-top:45px;"><!--성형외과, 피부과, 치과 탭-->
        	<a href="javascript:store.changeTab(0, 1);"><li id="li_30"><img src="/resources/img/menu/medical_tab01_on.png" alt="整形外科" /></li></a><!--선택탭 클래스 sel-->
        	<a href="javascript:store.changeTab(1, 1);"><li id="li_31"><img src="/resources/img/menu/medical_tab02.png" alt="皮肤科" /></li></a><!--선택탭 옆 오른쪽 탭에 클래스 no-->
        	<a href="javascript:store.changeTab(2, 1);"><li id="li_32" class="end"><img src="/resources/img/menu/medical_tab03.png" alt="牙科" /></li></a>
        </ul>
        ...
        <ul class="tab_detail_c3"><!--산부인과, 한의원, 관절척주 탭-->
        	<a href="javascript:store.changeTab(3, 1);"><li id="li_48"><img src="/resources/img/menu/medical_tab04_on.png" alt="妇产科" /></li></a><!--선택탭 클래스 sel-->
        	<a href="javascript:store.changeTab(4, 1);"><li id="li_49"><img src="/resources/img/menu/medical_tab05.png" alt="韩医院" /></li></a><!--선택탭 옆 오른쪽 탭에 클래스 no-->
        	<a href="javascript:store.changeTab(5, 1);"><li id="li_50" class="end"><img src="/resources/img/menu/medical_tab06.png" alt="关节脊椎" /></li></a>
        </ul>
        <table class="detail_c2">
        	<caption>산부인과</caption>
            <colgroup>
            	<col width="22%" />
                <col width="28%" />
                <col width="22%" />

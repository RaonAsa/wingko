...
var store = {
	...
	tab : {
		on: ["/resources/img/menu/beauty_tab01_on.png", "/resources/img/menu/beauty_tab02_on.png", "/resources/img/menu/beauty_tab03_on.png",
		     "/resources/img/menu/beauty_tab04_on.png", "/resources/img/menu/beauty_tab05_on.png", "/resources/img/menu/beauty_tab06_on.png"],
		off: ["/resources/img/menu/beauty_tab01.png", "/resources/img/menu/beauty_tab02.png", "/resources/img/menu/beauty_tab03.png",
		     "/resources/img/menu/beauty_tab04.png", "/resources/img/menu/beauty_tab05.png", "/resources/img/menu/beauty_tab06.png"],
		category: [27, 28, 29, 45, 46, 47],	// category_no
		id: ["li_27", "li_28", "li_29", "li_45", "li_46", "li_47"]	// tab li id
	},
...
<div id="Wrapper">
	...
	<div id="Content">
        ...
        <ul class="tab_detail_c3" style="margin-top:45px;"><!--미용실, 스파/마사지, 메이크업 탭-->
        	<a href="javascript:store.changeTab(0, 1);"><li id="li_27"><img src="/resources/img/menu/beauty_tab01_on.png" alt="美容院" /></li></a><!--선택탭 클래스 sel-->
        	<a href="javascript:store.changeTab(1, 1);"><li id="li_28"><img src="/resources/img/menu/beauty_tab02.png" alt="SPA/按摩" /></li></a><!--선택탭 옆 오른쪽 탭에 클래스 no-->
        	<a href="javascript:store.changeTab(2, 1);"><li id="li_29" class="end"><img src="/resources/img/menu/beauty_tab03.png" alt="化妆" /></li></a>
        </ul>
        ...
        <ul class="tab_detail_c3"><!--쁘띠성형, 네일아트, 두피관리 탭-->
        	<a href="javascript:store.changeTab(3, 1);"><li id="li_45"><img src="/resources/img/menu/beauty_tab04_on.png" alt="微整形" /></li></a><!--선택탭 클래스 sel-->
        	<a href="javascript:store.changeTab(4, 1);"><li id="li_46"><img src="/resources/img/menu/beauty_tab05.png" alt="美甲" /></li></a><!--선택탭 옆 오른쪽 탭에 클래스 no-->
        	<a href="javascript:store.changeTab(5, 1);"><li id="li_47" class="end"><img src="/resources/img/menu/beauty_tab06.png" alt="头皮管理" /></li></a>
        </ul>
        <table class="detail_c2">
        	<caption>문화</caption>
            <colgroup>

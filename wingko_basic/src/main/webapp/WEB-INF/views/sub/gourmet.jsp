...
var store = {
	...
	tab : {
		on: ["/resources/img/menu/gourmet_restaurants_tab01_on.png", "/resources/img/menu/gourmet_restaurants_tab02_on.png", "/resources/img/menu/gourmet_restaurants_tab03_on.png", "/resources/img/menu/gourmet_restaurants_tab04_on.png",
		     "/resources/img/menu/gourmet_restaurants_tab05_on.png", "/resources/img/menu/gourmet_restaurants_tab06_on.png", "/resources/img/menu/gourmet_restaurants_tab07_on.png"],
		off: ["/resources/img/menu/gourmet_restaurants_tab01.png", "/resources/img/menu/gourmet_restaurants_tab02.png", "/resources/img/menu/gourmet_restaurants_tab03.png", "/resources/img/menu/gourmet_restaurants_tab04.png",
		     "/resources/img/menu/gourmet_restaurants_tab05.png", "/resources/img/menu/gourmet_restaurants_tab06.png", "/resources/img/menu/gourmet_restaurants_tab07.png"],
		category: [14, 24, 25, 26, 42, 43, 44],	// category_no
		id: ["li_14", "li_24", "li_25", "li_26", "li_42", "li_43", "li_44"]	// tab li id
	},
...
<div id="Wrapper">
	...
	<div id="Content">
        ...
        <ul class="tab_detail_c4" style="margin-top:45px;"><!--한식, 중식, 양식, 일식 탭-->
        	<a href="javascript:store.changeTab(0, 1);"><li id="li_14"><img src="/resources/img/menu/gourmet_restaurants_tab01_on.png" alt="韩式" /></li></a><!--선택탭 클래스 sel-->
        	<a href="javascript:store.changeTab(1, 1);"><li id="li_24"><img src="/resources/img/menu/gourmet_restaurants_tab02.png" alt="中式" /></li></a><!--선택탭 옆 오른쪽 탭에 클래스 no-->
        	<a href="javascript:store.changeTab(2, 1);"><li id="li_25"><img src="/resources/img/menu/gourmet_restaurants_tab03.png" alt="西式" /></li></a>
        	<a href="javascript:store.changeTab(3, 1);"><li id="li_26" class="end"><img src="/resources/img/menu/gourmet_restaurants_tab04.png" alt="日式" /></li></a>
        </ul>
        ...
        <ul class="tab_detail_c3"><!--게스트하우스, 홈스테이, 캠핑 탭-->
        	<a href="javascript:store.changeTab(4, 1);"><li id="li_42"><img src="/resources/img/menu/gourmet_restaurants_tab05_on.png" alt="融合菜" /></li></a><!--선택탭 클래스 sel-->
        	<a href="javascript:store.changeTab(5, 1);"><li id="li_43"><img src="/resources/img/menu/gourmet_restaurants_tab06.png" alt="咖啡屋&甜点" /></li></a><!--선택탭 옆 오른쪽 탭에 클래스 no-->
        	<a href="javascript:store.changeTab(6, 1);"><li id="li_44" class="end"><img src="/resources/img/menu/gourmet_restaurants_tab07.png" alt="休息室&酒吧" /></li></a>
        </ul>
        <table class="detail_c2">

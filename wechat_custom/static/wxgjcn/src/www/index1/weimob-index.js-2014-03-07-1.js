(function() {
    var e = function(e) {
        ...
        return function n(r, i) {
            t.clearProxy = n.clearProxy = e, e(), window.timerProxyTimeout = window.setTimeout(function() {
                $.isFunction(r) && r()
            }, i)
        }
    }(), n;
    (function() {
        var r = 0, i = function(e) {
            $(".changing-over .now").removeClass("now"), $(".changing-over>a").eq(e).addClass("now"), r = e
        }, s = e(function(e) {
            ...
            $(".hd-c .banner .pic-intro").hide(), $($(".hd-c .banner .pic-intro")[r]).fadeOut("fast", function() {
                $($(".hd-c .banner .pic-intro")[e]).fadeIn("fast"), i(e), t()
            })
        });
        n = function() {
            r = 0;
            ...
            $(".changing-over>a").click(function(e) {
                ...
                s((r + e - 1)%e), t.preventDefault()
            }), $(".hd-c .banner .next").click(function(t) {
                s((r + 1)%e), t.preventDefault()
            });
    ...
    (function() {
        var e = function(e) {
            ...
            for (var n = 0; n < e.length; n++)
                t += '<span class="additional-error-message">' + e[n] + "</span>";
            return t
        }, o = function(t) {
            var r = t.types, o = t.elem, u = t.concat || "or";
            o.parent().find(".additional-error-message").remove();
            if (!!t.additional && t.additional())
                return !0;
            n = [];
            var a = e(o.val()), f = i[u](r, a);
            return $.isArray(f) ? (o.after(s(f)), !1) : !0
        }, u = function(e) {
            var t = e.configs;
            for (var n = 0; n < t.length; n++)(function(e) {
                var n = t[e];
                n.elem.bind("change", function() {
                    o(n)
                })
            })(n)
        }, a = function(e) {
            var t = e.callback, n = e.configs, r=!0;
    ...
    var i;
    (function() {
        var e = 5, t = $("#share"), n = parseInt(t.css("top"));
        i = function() {
...
$(document).ready(function() {
    if (((/weimob.cn/i.test(window.location)))) {
        var $foot = $("div.foot-menu");
        var html = $foot.html().replace("免费热线：4006305400", "免费热线：021-55780059").replace("上海市杨浦区政益路28号1106-1109室", "上海市宝山区逸仙路2816号15楼");
        $foot.html(html);
    }
});

(function(e, t) {
    ...
    function f(e) {
        ...
        if (!(e.liveFired === this ||!o ||!o.live || e.button && e.type === "click")) {
            ...
            for (a = 0; a < c.length; a++)
                o = c[a], o.origType.replace(V, "") === e.type ? r.push(o.selector) : c.splice(a--, 1);
            s = m(e.target).closest(r, e.currentTarget), f = 0;
            for (l = s.length; f < l; f++)
                for (a = 0; a < c.length; a++) {
                    o = c[a];
                    if (s[f].selector === o.selector) {
                        u = s[f].elem, r = null;
                        if (o.preType === "mouseenter" || o.preType === "mouseleave")
                            r = m(e.relatedTarget).closest(o.selector)[0];
                            (!r || r !== u) && n.push({
                                elem: u,
                                handleObj: o
                            })
        ...
        t.each(function() {
            if (this.nodeName === (e[n] && e[n].nodeName)) {
                ...
                if (t = t && t.events) {
                    ...
                    for (var i in t)
                        for (var s in t[i])
                            m.event.add(this, i, t[i][s], t[i][s].data)
                        }
            }
        })
    }
    ...
    m.fn = m.prototype = {
        init: function(e, n) {
            ...
            if (e === "body"&&!n)
                return this.context = b, this[0] = b.body, this.selector = "body", this.length = 1, this;
            if (typeof e == "string") {
                if ((r = E.exec(e)) && (r[1] ||!n)) {
                    if (r[1])
                        return i = n ? n.ownerDocument || n : b, (e = N.exec(e)) ? m.isPlainObject(n) ? (e = [b.createElement(e[1])], m.fn.attr.call(e, n, !0)) : e = [i.createElement(e[1])] : (e = p([r[1]], [i]), e = (e.cacheable ? e.fragment.cloneNode(!0) : e.fragment).childNodes), m.merge(this, e);
        ...
        for (; n < r; n++)
            if ((s = arguments[n]) != null)
                for (o in s)
                    u = e[o], a = s[o], e !== a && (i && a && (m.isPlainObject(a) || m.isArray(a)) ? (u = u && (m.isPlainObject(u) || m.isArray(u)) ? u : m.isArray(a) ? [] : {}, e[o] = m.extend(i, u, a)) : a !== t && (e[o] = a));
        return e
    }, m.extend({
        ...
        bindReady: function() {
            if (!k) {
                ...
                if (b.addEventListener)
                    b.addEventListener("DOMContentLoaded", A, !1), e.addEventListener("load", m.ready, !1);
        ...
        isPlainObject: function(e) {
            if (!e || O.call(e) !== "[object Object]" || e.nodeType || e.setInterval)
                return !1;
        ...
        each: function(e, n, r) {
            ...
            if (r) {
                ...
                for (r = e[0]; s < o && n.call(r, s, r)!==!1; r = e[++s]);
            return e
        },
        trim: function(e) {
            return (e || "").replace(T, "")
        ...
        map: function(e, t, n) {
            for (var r = [], i, s = 0, o = e.length; s < o; s++)
        ...
        r.style.display = "none", r.innerHTML = "   <link/><table></table><a href='httpa' style='color:red;float:left;opacity:.55;'>a</a><input type='checkbox'/>";
        ...
        if (!(!o ||!o.length ||!u)) {
            ...
            t.insertBefore(n, t.firstChild), e[i] && (m.support.scriptEval=!0, delete e[i]);
            try {
                delete n.test
            } catch (f) {
    ...
    m.fn.extend({
        ...
        addClass: function(e) {
            ...
            if (e && typeof e == "string")
                for (var t = (e || "").split(I), n = 0, r = this.length; n < r; n++) {
                    var i = this[n];
                    if (i.nodeType === 1)
                        if (i.className) {
                            for (var s = " " + i.className + " ", o = i.className, u = 0, a = t.length; u < a; u++)
                                s.indexOf(" " + t[u] + " ") < 0 && (o += " " + t[u]);
        ...
        removeClass: function(e) {
            ...
            if (e && typeof e == "string" || e === t)
                for (var n = (e || "").split(I), r = 0, i = this.length; r < i; r++) {
                    var s = this[r];
                    if (s.nodeType === 1 && s.className)
                        if (e) {
                            for (var o = (" " + s.className + " ").replace(F, " "), u = 0, a = n.length; u < a; u++)
                                o = o.replace(" " + n[u] + " ", " ");
        ...
        toggleClass: function(e, t) {
            ...
            return m.isFunction(e) ? this.each(function(n) {
                ...
                if (n === "string")
                    for (var i, s = 0, o = m(this), u = t, a = e.split(I); i = a[s++];)
                        u = r ? u : !o.hasClass(i), o[u ? "addClass": "removeClass"](i);
                else if (n === "undefined" || n === "boolean")
                    this.className && m.data(this, "__className__", this.className), this.className = this.className || e===!1 ? "" : m.data(this, "__className__") || ""
            })
        },
        hasClass: function(e) {
            e = " " + e + " ";
            for (var t = 0, n = this.length; t < n; t++)
                if ((" " + this[t].className + " ").replace(F, " ").indexOf(e)>-1)
                    return !0;
            return !1
        },
        val: function(e) {
            ...
            return this.each(function(t) {
                ...
                if (this.nodeType === 1) {
                    ...
                    if (m.isArray(r) && X.test(this.type))
                        this.checked = m.inArray(n.val(), r) >= 0;
    ...
    m.event = {
            ...
            if (n.nodeType !== 3 && n.nodeType !== 8) {
                ...
                if (u = m.data(n)) {
                    ...
                    for (var l, c = 0, h; l = r[c++];) {
                        ...
                        if (!p) {
                            p = a[l] = [];
                            if (!d.setup || d.setup.call(n, s, h, f)===!1)
                                n.addEventListener ? n.addEventListener(l, f, !1) : n.attachEvent && n.attachEvent("on" + l, f)
                            }
        ...
        remove: function(e, t, n, r) {
                            ...
                            if (l = p[i])
                                if (n) {
                                    ...
                                    for (d = r || 0; d < l.length; d++) {
                                        c = l[d];
                                        if (n.guid === c.guid) {
                                            if (o || a.test(c.namespace))
                                                r == null && l.splice(d--, 1), f.remove && f.remove.call(e, c);
                                                if (r != null)
                                                    break
                                        }
                                    }
                                    ...
                                    for (var d = 0; d < l.length; d++) {
                                        c = l[d];
                                        if (o || a.test(c.namespace))
                                            m.event.remove(e, f, c.handler, d), l.splice(d--, 1)
                                        }
                                }
            ...
            if (!e.isPropagationStopped() && i)
                m.event.trigger(e, n, i, !0);
                ...
                if ((!f._default || f._default.call(r, e)===!1)&&!a&&!(i && i.nodeName && m.noData[i.nodeName.toLowerCase()])) {
                    ...
                    u && (i["on" + s] = u), m.event.triggered=!1
                }
            }
        }, handle: function(n) {
            var r, i, s, o;
            ...
            var n = e;
            e = m.Event(n);
            for (var r = this.props.length, i; r;)
    ...
    var J = b.removeEventListener ? function(e,
    t,
    n) {
    ...
    m.each({
        ...
        setup: function() {
            ...
            m.event.add(this, "click.specialSubmit", function(e) {
                ...
                if ((n === "submit" || n === "image") && m(t).closest("form").length)
                    return a("submit", this, arguments)
            }), m.event.add(this, "keypress.specialSubmit", function(e) {
                var t = e.target, n = t.type;
                if ((n === "text" || n === "password") && m(t).closest("form").length && e.keyCode === 13)
                    return a("submit", this, arguments)
            })
        },
        teardown: function() {
    ...
    if (!m.support.changeBubbles) {
        var G = /textarea|input|select/i, Y, Z = function(e) {
            ...
            if (!!G.test(r.nodeName)&&!r.readOnly) {
                ...
                if (i !== t && s !== i)
                    if (i != null || s)
                        return e.type = "change", m.event.trigger(e, n, r)
            }
        };
        m.event.special.change = {
            ...
            setup: function() {
                if (this.type === "file")
                    return !1;
                for (var e in Y)
                    m.event.add(this, e + ".specialChange", Y[e]);
    ...
    b.addEventListener && m.each({
        ...
        m.fn[n] = function(e, r, i) {
            ...
            if (e === "unload" && n !== "one")
                ...
                s = 0;
                for (var u = this.length; s < u; s++)
                    m.event.add(this[s], e, o, r)
            }
            return this
        }
    }), m.fn.extend({
        ...
        triggerHandler: function(e, t) {
            if (this[0])
                return e = m.Event(e), e.preventDefault(), e.stopPropagation(), m.event.trigger(e, t, this[0]), e.result
        },
        toggle: function(e) {
            for (var t = arguments, n = 1; n < t.length;)
                m.proxy(e, t[n++]);
    ...
    m.each(["live", "die"], function(e, n) {
        ...
        var f = function(e, t, n, r) {
            ...
            if (u.length > 1 && c.exec(e))
                if (u.length === 2 && l.relative[u[0]])
                    ...
                    for (h = l.relative[u[0]] ? [t] : f(u.shift(), t); u.length;)
            ...
            if (o.call(d) === "[object Array]")
                if (m)
                    if (t && t.nodeType === 1)
                        for (e = 0; d[e] != null; e++)
                            d[e] && (d[e]===!0 || d[e].nodeType === 1 && g(t, d[e])) && n.push(h[e]);
                    else 
                        for (e = 0; d[e] != null; e++)
        ...
        f.uniqueSort = function(e) {
            ...
            for (var s = e, o = [], u = n, a, c, h = n && n[0] && y(n[0]); e && n.length;) {
                for (var p in l.filter)
                    if ((a = l.leftMatch[p].exec(e)) != null && a[2]) {
                        ...
                        if (m.substr(m.length - 1) !== "\\") {
                            u === o && (o = []);
                            if (l.preFilter[p])
                                if (a = l.preFilter[p](a, u, r, o, i, h)) {
                                    if (a===!0)
                                        continue
                                } else 
                                    c = v=!0;
        ...
        : function(e, t) {
            ...
            var n = [], r = "", i;
            for (t = t.nodeType ? [t] : t; i = l.match.PSEUDO.exec(e);)
    ...
    m.fn.extend({
            ...
            if (m.isArray(e)) {
                ...
                if (r && e.length) {
                    ...
                    for (var u = e.length; i < u; i++)
                        o = e[i], s[o] || (s[o] = m.expr.match.POS.test(o) ? m(o, t || this.context) : o);
                    for (; r && r.ownerDocument && r !== t;) {
                        for (o in s) {
                            i = s[o];
                            if (i.jquery ? i.index(r)>-1 : m(r).is(i))
                                n.push({
                                    selector: o,
                                    elem: r
                                }), delete s[o]
        ...
        dir: function(e, n, r) {
            var i = [];
            for (e = e[n]; e && e.nodeType !== 9 && (r === t || e.nodeType !== 1 ||!m(e).is(r));)
    ...
    mt.optgroup = mt.option, mt.tbody = mt.tfoot = mt.colgroup = mt.caption = mt.thead, mt.th = mt.td, m.support.htmlSerialize || (mt._default = [1, "div<div>", "</div>"]), m.fn.extend({
        ...
        remove: function(e, t) {
            for (var n = 0, r; (r = this[n]) != null; n++)
                if (!e || m.filter(e, [r]).length)!t && r.nodeType === 1 && (m.cleanData(r.getElementsByTagName("*")), m.cleanData([r])), r.parentNode && r.parentNode.removeChild(r);
            return this
        },
        empty: function() {
            for (var e = 0, t; (t = this[e]) != null; e++)
                for (t.nodeType === 1 && m.cleanData(t.getElementsByTagName("*")); t.firstChild;)
            ...
            if (typeof e == "string"&&!pt.test(e) && (m.support.leadingWhitespace ||!ut.test(e))&&!mt[(lt.exec(e) || ["", ""])[1].toLowerCase()]) {
                ...
                try {
                    for (var n = 0, r = this.length; n < r; n++)
                        this[n].nodeType === 1 && (m.cleanData(this[n].getElementsByTagName("*")), this[n].innerHTML = e)
                    } catch (i) {
                    this.empty().append(e)
                }
            } else 
        ...
        domManip: function(e, n, i) {
            ...
            var o, u, a = e[0], f = [], l;
            if (!m.support.checkClone && arguments.length === 3 && typeof a == "string" && dt.test(a))
                return this.each(function() {
            ...
            if (this[0]) {
                ...
                if (u = l.childNodes.length === 1 ? l = l.firstChild : l.firstChild) {
                    ...
                    for (var c = 0, h = this.length; c < h; c++)
                        i.call(n ? s(this[c], u) : this[c], c > 0 || o.cacheable || this.length > 1 ? l.cloneNode(!0) : l)
                    }
                f.length && m.each(f, r)
            }
            return this
        ...
        m.fn[e] = function(n) {
            ...
            if (i && i.nodeType === 11 && i.childNodes.length === 1 && n.length === 1)
        ...
        clean: function(e, t, n, r) {
            ...
            if (n)
                for (s = 0; i[s]; s++)
                    r && m.nodeName(i[s], "script") && (!i[s].type || i[s].type.toLowerCase() === "text/javascript") ? r.push(i[s].parentNode ? i[s].parentNode.removeChild(i[s]) : i[s]) : (i[s].nodeType === 1 && i.splice.apply(i, [s + 1, 0].concat(m.makeArray(i[s].getElementsByTagName("script")))), n.appendChild(i[s]));
            return i
        },
        cleanData: function(e) {
            for (var t, n, r = m.cache, i = m.event.special, s = m.support.deleteExpando, o = 0, u; (u = e[o]) != null; o++)
                if (n = u[m.expando]) {
                    t = r[n];
                    if (t.events)
                        for (var a in t.events)
                            i[a] ? m.event.remove(u, a) : J(u, a, t.handle);
    ...
    m.fn.css = function(e, n) {
        ...
        curCSS: function(e, t, n) {
            var r, i = e.style;
            if (!m.support.opacity && t === "opacity" && e.currentStyle)
                return r = bt.test(e.currentStyle.filter || "") ? parseFloat(RegExp.$1) / 100 + "" : "", r === "" ? "1" : r;
            wt.test(t) && (t = At);
            if (!n && i && i[t])
                r = i[t];
            else if (Lt) {
    ...
    m.fn.extend({
        ...
        ajax: function(n) {
            ...
            if (u.dataType === "jsonp") {
                if (h === "GET")
                    Ht.test(u.url) || (u.url += (Bt.test(u.url) ? "&" : "?") + (u.jsonp || "callback") + "=?");
                else if (!u.data ||!Ht.test(u.data))
            ...
            if (E) {
                ...
                if (u.beforeSend && u.beforeSend.call(c, E, u)===!1)
                    return u.global&&!--m.active && m.event.trigger("ajaxStop"), E.abort(), !1;
                u.global && o("ajaxSend", [E, u]);
                var x = E.onreadystatechange = function(e) {
                    if (!E || E.readyState === 0 || e === "abort")
                        w || i(), w=!0, E && (E.onreadystatechange = m.noop);
    ...
    m.fn.extend({
        show: function(e, t) {
            if (e || e === 0)
                return this.animate(d("show", 3), e, t);
            e = 0;
            ...
            e = 0;
            for (t = this.length; e < t; e++)
                this[e].style.display = m.data(this[e], "olddisplay") || "";
            return this
        },
        hide: function(e, t) {
            if (e || e === 0)
                return this.animate(d("hide", 3), e, t);
            e = 0;
            for (t = this.length; e < t; e++) {
                var n = m.data(this[e], "olddisplay");
                ...
                if (n) {
                    ...
                    if (this.options.hide || this.options.show)
                        for (var i in this.options.curAnim)
                            m.style(this.elem, i, this.options.orig[i]);
        ...
        tick: function() {
            for (var e = m.timers, t = 0; t < e.length; t++)
                e[t]() || e.splice(t--, 1);
            e.length || m.fx.stop()
        },
        stop: function() {
        ...
        for (var a = t.offsetTop, f = t.offsetLeft; (t = t.parentNode) && t !== u && t !== o;) {
            if (m.offset.supportsFixedPosition && r.position === "fixed")
                break;
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || b.body; e&&!/^body|html$/i.test(e.nodeName) && m.css(e, "position") === "static";)
                    e = e.offsetParent;
                return e
            })
        }
...
var swfobject = function() {
    ...
    function T(t) {
        ...
        else if (typeof u.addEventListener != e)
    ...
    function N() {
        ...
        for (var t = 0; t < e; t++) {
            ...
            if (b.pv[0] > 0) {
                var r = P(n);
                r && (l[t].width = r.getAttribute("width") ? r.getAttribute("width") : "0", l[t].height = r.getAttribute("height") ? r.getAttribute("height") : "0", j(l[t].swfVersion) ? (b.webkit && b.webkit < 312 && C(r), I(n, !0)) : l[t].expressInstall&&!y && j("httpsrc/www/index1/6.0.65") && (b.win || b.mac) ? k(l[t]) : L(r))
            } else 
                I(n, !0)
        }
    }
    function C(e) {
        ...
        if (n) {
            ...
            if (i) {
                var s = i.length;
                for (var o = 0; o < s; o++)
                    i[o].nodeName == "DATA" ? r.setAttribute("src", i[o].nodeValue) : r.setAttribute(i[o].nodeName, i[o].nodeValue)
                }
            var u = n.childNodes;
            if (u) {
                var a = u.length;
                for (var f = 0; f < a; f++)
                    u[f].nodeType == 1 && u[f].nodeName == "PARAM" && r.setAttribute(u[f].getAttribute("name"), u[f].getAttribute("value"))
                }
    ...
    function L(e) {
        if (b.ie && b.win && e.readyState != 4) {
            ...
            e.parentNode.replaceChild(A(e), e)
    }
    function A(e) {
        var n = H("div");
        if (b.win && b.ie)
    ...
    function O(n, r, s) {
        ...
        if (u) {
            ...
            if (b.ie && b.win) {
                ...
                var l = "";
                for (var h in r)
                    r[h] != Object.prototype[h] && (l += '<param name="' + h + '" value="' + r[h] + '" />');
                ...
                for (var d in n)
                    n[d] != Object.prototype[d] && (d.toLowerCase() == "data" ? p.setAttribute("src", n[d]) : d.toLowerCase() == "styleclass" ? p.setAttribute("class", n[d]) : d.toLowerCase() != "classid" && p.setAttribute(d, n[d]));
                for (var v in r)
                    r[v] != Object.prototype[v] && v.toLowerCase() != "movie" && p.setAttribute(v, r[v]);
                u.parentNode.replaceChild(p, u), o = p
            } else {
                var m = H(t);
                m.setAttribute("type", i);
                for (var g in n)
                    n[g] != Object.prototype[g] && (g.toLowerCase() == "styleclass" ? m.setAttribute("class", n[g]) : g.toLowerCase() != "classid" && m.setAttribute(g, n[g]));
                for (var y in r)
                    r[y] != Object.prototype[y] && y.toLowerCase() != "movie" && M(m, y, r[y]);
    ...
    var e = "undefined", t = "object", n = "Shockwave Flash", r = "ShockwaveFlash.ShockwaveFlash", i = "application/x-shockwave-flash", s = "SWFObjectExprInst", o = window, u = document, a = navigator, f = [], l = [], c = [], h = [], p, d = null, v = null, m = null, g=!1, y=!1, b = function() {
        ...
        if (typeof a.plugins != e && typeof a.plugins[n] == t)
            l = a.plugins[n].description, l && (typeof a.mimeTypes == e ||!a.mimeTypes[i]||!!a.mimeTypes[i].enabledPlugin) && (l = l.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), f[0] = parseInt(l.replace(/^(.*)\..*$/, "$1"), 10), f[1] = parseInt(l.replace(/^.*\.(.*)\s.*$/, "$1"), 10), f[2] = /r/.test(l) ? parseInt(l.replace(/^.*r(.*)$/, "$1"), 10) : 0);
    ...
    return {
        ...
        embedSWF: function(n, r, i, s, o, u, a, f, l) {
            ...
            if (j(o)) {
                ...
                if (l && typeof l === t)
                    for (var h in l)
                        l[h] != Object.prototype[h] && (c[h] = l[h]);
                c.data = n, c.width = i, c.height = s;
                var p = {};
                if (f && typeof f === t)
                    for (var d in f)
                        f[d] != Object.prototype[d] && (p[d] = f[d]);
                if (a && typeof a === t)
                    for (var v in a)
                        a[v] != Object.prototype[v] && (typeof p.flashvars != e ? p.flashvars += "&" + v + "=" + a[v] : p.flashvars = v + "=" + a[v]);
                x(function() {
                    O(c, p, r), c.id == r && I(r, !0)
                })
            } else 
                u&&!y && j("httpsrc/www/index1/6.0.65") && (b.win || b.mac) && (y=!0, I(r, !1), x(function() {
                    var e = {};
...
document.domain = "httpsrc/www/index1/weimob.com";
$(function() {
